...
export const GOOGLE_SPANISH_VOICES: VoiceOption[] = [
  { id: 'es-US-Neural2-B', name: 'Diego', gender: 'MALE', tone: 'Warm & Natural', flag: '👨', pitch: 0.72, rate: 0.88 },
  { id: 'es-US-Neural2-C', name: 'Mateo', gender: 'MALE', tone: 'Calm & Authoritative', flag: '🧔', pitch: 0.65, rate: 0.84 },
  { id: 'es-US-Neural2-A', name: 'Sofia', gender: 'FEMALE', tone: 'Clear & Friendly', flag: '👩', pitch: 1.05, rate: 0.92 },
  { id: 'es-US-Journey-F', name: 'Valeria', gender: 'FEMALE', tone: 'Young & Expressive', flag: '👧', pitch: 1.15, rate: 0.95 },
];
